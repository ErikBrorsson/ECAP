...
class HRDAEncoderDecoder(EncoderDecoder):
    ...
    def forward_train_logits(self,
        ...
        decode_losses = dict()
        loss_decode, seg_logits = self.decode_head.forward_train_logits(mres_feats, img_metas,
                                                     gt_semantic_seg,
                                                     self.train_cfg,
                                                     seg_weight)
        decode_losses.update(add_prefix(loss_decode, 'decode'))

        losses.update(decode_losses)
